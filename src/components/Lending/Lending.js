  ...
  return (
    <>
      <div className="w-full pt-16 mx-auto lg:px-28">
        <div className="flex flex-col w-full mx-auto mb-2 prose prose-md">
          <div className="mb-5 border-b border-gray-200">
            <div className="items-baseline -mt-2">
              <p className="my-1 text-3xl text-center font-black mb-6">Peer-to-Peer Lending</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2">
        <section>
          <div className="relative items-center w-full px-5 py-6 mx-auto md:px-12 lg:px-24">
            <div className="grid grid-cols-1 ">
              <div className="w-full max-w-lg mx-auto my-4 bg-white shadow-xl rounded-xl">
                <div className="p-6 lg:text-center">
                  ...
                  <h4 className="mt-4 text-2xl font-semibold leading-none text-center tracking-tighter text-neutral-600 lg:text-3xl ">
                    I am a Borrower
                  </h4>
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                If you'd like to borrow money to finance your SME, please sign in as an SME.
                  </p>
                </div>
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    If you'd like to invest and lend money to SMEs, please sign in as a Lender.
                  </p>
                </div>
